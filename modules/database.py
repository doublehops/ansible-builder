...
def include_database(outputPath, params):
    ...
    shutil.copytree('provisioners_core/roles/database', outputPath +'/provisioners/roles/database')
    taskSrc = 'provisioners_templates/roles/database/tasks/'+ params['type'] +'-'+ params['operating_system'] +'.yml'
