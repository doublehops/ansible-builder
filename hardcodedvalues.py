...
oses = {
         'debian9': { 'installer': 'apt', 'vagrantbox': 'debian/stretch64', 'vagrantbox_url': '' },
         'debian': { 'installer': 'apt', 'vagrantbox': 'debian/jessie64', 'vagrantbox_url': 'https://atlas.hashicorp.com/debian/boxes/jessie64' },
         ...
         'ubuntu16': { 'installer': 'apt', 'vagrantbox': 'ubuntu/trusty64', 'vagrantbox_url': 'https://vagrantcloud.com/ubuntu/trusty64'},
}
